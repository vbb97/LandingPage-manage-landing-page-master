    ...
    return (
        <section className="sm:pt-14 sm:flex sm:flex-col sm:items-center sm:gap-14">
            ...
            <div className="sm:px-4 sm:flex sm:flex-col sm:gap-4 sm:items-center sm:text-center">
                ...
                <h4 className="sm:font-black md:text-lg">Anisha Li</h4>
            ...
            <button className="sm:py-3 sm:px-8 sm:bg-primaryBrightRed sm:text-neutralVeryLightGray sm:text-sm sm:rounded-3xl sm:hover:opacity-65 md:text-xl">Get Started</button>
        </section>
    )
}