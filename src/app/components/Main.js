    ...
    return (
        <section className="sm:flex sm:flex-col sm:items-center sm:text-center sm:z-0">
            ...
            <div className="sm:pb-32 sm:px-6 sm:bg-[url('/images/bg-tablet-pattern.svg')] sm:bg-no-repeat sm:bg-bottom-4 sm:bg-contain">
                <h1 className="sm:text-3xl sm:font-extrabold  md:text-4xl">Bring everyone together to build better products.</h1>
                ...
                <button className="sm:mt-8 sm:py-3 sm:px-8 sm:bg-primaryBrightRed sm:text-neutralVeryLightGray sm:text-sm sm:rounded-3xl sm:hover:opacity-65 md:text-xl">Get Started</button>
            </div>
        </section>
    )
}