...
export default function Main () {
    return (
        <section className="sm:flex sm:flex-col sm:items-center sm:text-center sm:z-0 2lg:px-12 xl:flex-row-reverse">
            ...
            <div className="sm:pb-32 sm:px-6 sm:relative">
                <Image width={514} height={514} className="sm:absolute sm:bottom-0 sm:-right-72 sm:-z-10" src="/images/bg-tablet-pattern.svg"/>
